    ...
    return (
      <Form layout="inline" className="chart-form fr">
        <FormItem className="fr mar-r0">
          <Button onClick={() => openHistoryModal()} size={"small"}>
            历史
          </Button>
        </FormItem>
        ...
        <FormItem className="fr">
          <Select
            size="small"
            defaultValue={this.state.chartParams.period}
            onChange={this.periodSelectChange}
            style={{ width: 60 }}
          >
        ...
        <FormItem className="fr">
          <RangePicker
            ...
            showTime
            defaultValue={[
              this.state.chartParams.start,
              this.state.chartParams.end,
            ]}
            format="YYYY-MM-DD HH:mm:ss"
            onOk={this.changeDateTime}
            style={{ width: 220 }}
          />
        </FormItem>
      </Form>
