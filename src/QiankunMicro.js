// 导入乾坤函数
import { registerMicroApps, runAfterFirstMounted, setDefaultMountApp, addGlobalUncaughtErrorHandler, start, initGlobalState } from 'qiankun';
